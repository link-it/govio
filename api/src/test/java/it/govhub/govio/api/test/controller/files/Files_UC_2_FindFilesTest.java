...
class Files_UC_2_FindFilesTest {
	...
	// 16. findAllOk filtro status = created
	@Test
	void UC_2_16_FindAllOk_StatusCreated() throws Exception {
		MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
		params.add(Costanti.USERS_QUERY_PARAM_STATUS, GovioFileEntity.Status.CREATED.toString());
	...
	// 17. findAllOk filtro status = processed
	@Test
	void UC_2_17_FindAllOk_StatusProcessed() throws Exception {
		MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
		params.add(Costanti.USERS_QUERY_PARAM_STATUS, GovioFileEntity.Status.PROCESSED.toString());
	...
	// 18. findAllOk filtro status = processing
	@Test
	void UC_2_19_FindAllOk_StatusProcessing() throws Exception {
		MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
		params.add(Costanti.USERS_QUERY_PARAM_STATUS, GovioFileEntity.Status.PROCESSING.toString());
